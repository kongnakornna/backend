...
$config['www']='http://'.$_SERVER['HTTP_HOST'].'/backend/';
$config['api']='http://'.$_SERVER['HTTP_HOST'].'/apici/';
$config['base_url']='http://'.$_SERVER['HTTP_HOST'].'/backend/';
$config['base_path']='http://'.$_SERVER['HTTP_HOST'].'/backend';
$config['frontend']='http://'.$_SERVER['HTTP_HOST'].'/backend/';
...
$config['sess_cookie_name'] = 'democi_sessions_';
