...
class Mul_leveltb_code extends REST_Controller{

    public function __construct() {
                parent::__construct();
                $this->load->model('True/Model_mul_leveltb_code');
    } 
...
//data_get
	...
	// respond with information about a user
		#  /api/True/Mul_leveltb_code/data/?format=html
		#  /api/True/Mul_leveltb_code/data/?format=xml
		#  /api/True/Mul_leveltb_code/data/?format=json
		$order_by='desc';
		$limit='10000';
		$lang='th';
		//$data = $this->Model_mul_leveltb_code->list_all_data($order_by,$limit);
		$data = $this->Model_mul_leveltb_code->list_all_data($order_by,$limit);
		if($data){
			    $count=count($data);				
			    $this->set_response([
...
//data_where_id_get
	public function where_id_get($id=1){
		   ob_end_clean();
			#  /api/True/Mul_leveltb_code/where_id/1?format=html
			#  /api/True/Mul_leveltb_code/where_id/1?format=xml
			#  /api/True/Mul_leveltb_code/where_id/1?format=json
	        $data = $this->Model_mul_leveltb_code->read_where_id($id);
			if($data){
				    $this->set_response([
		            	'code' => 200,
		                'status' => TRUE,
...
//data_where_id_get
	public function where_id_lang_get($id=1,$lang='th'){
			ob_end_clean();
			#  /api/True/Mul_leveltb_code/where_id_lang/1/th?format=html
			#  /api/True/Mul_leveltb_code/where_id_lang/1/th?format=xml
			#  /api/True/Mul_leveltb_code/where_id_lang/1/th?format=json
	        $data = $this->Model_mul_leveltb_code->read_where_lang_id($id,$lang);
	        $count=count($data);
			if($data){
				    $this->set_response([
		            	'code' => 200,
...
//data_update_put
	public function update_put(){
			ob_end_clean();
			// create a new Mul_leveltb_code and respond with a status/Massages
		$data = $this->input->input_stream();
		$id = $this->uri->segment(4);
		//echo '$id=>'.$id;
        $result=$this->Model_mul_leveltb_code->update($data,$id);
		if($result){
				    $this->set_response([
		            	'code' => 200,
		                'status' => TRUE,
...
//data_update_post
	public function update_post(){
         ...
         $data = array(
				'wallet_typepackage_id'=> $this->post('wallet_Mul_leveltb_code_id'),
				'wallet_package_name'=> $this->post('wallet_Mul_leveltb_code_id'),
				'startsalary'=> $this->post('wallet_Mul_leveltb_code_id'),
				'endsalary'=> $this->post('wallet_Mul_leveltb_code_id'),
				'normal'=> $this->post('wallet_Mul_leveltb_code_id'),
				'special'=> $this->post('wallet_Mul_leveltb_code_id'),
				'status'=> $this->post('wallet_Mul_leveltb_code_id'),
				'useoption'=> $this->post('wallet_Mul_leveltb_code_id'),
	...
	public function update_lang_post(){
		...
		//debug($data); die();
        $result=$this->Model_mul_leveltb_code->update_lang($data,$id,$lang);
		if($result){
				    $this->set_response([
		            	'code' => 200,
		                'status' => TRUE,
...
//data_insert_put
	public function insert_put(){
		...
		#debug($data); die();
		//echo '$id=>'.$id;
        $result=$this->Model_mul_leveltb_code->insert($data);
		if($result){
				    $this->set_response([
		            	'code' => 200,
		                'status' => TRUE,
...
//data_delete_delete
	public function delete_data_delete(){
        ...
        $result = $this->Model_mul_leveltb_code->delete($id);
