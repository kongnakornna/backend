...
<head>
    <meta charset="utf-8">
    <title>REST API Server V.1.0</title>
...
<div id="container">
    ...
    <div id="body">
		...
		<p>
            Rest Documentation
            <a href="<?php echo base_url('documentation');?>" target="_blank"> Documentation </a>
        </p>
		...
		<p>
            user guide CI
            <a href="<?php echo base_url('user_guide_src');?>" target="_blank"> user guide </a>
        </p>
