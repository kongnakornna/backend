var TableData = function () {
    ...
    var runDataTable = function () {
        var oTable = $('#sample_1').dataTable({
            ...
            "aLengthMenu": [
                [5, 10,20,40,100,150, -1],
                [5, 10,20,40,100,150, "All"] // change per page values here
            ],
    ...
    var runEditableTable = function(){
		...
		var oTable = $('#sample_2').dataTable({
			...
			"aaSorting" : [[0, 'asc']],
			"aLengthMenu" : [[5, 10, 15, 20,40,80,120, -1], [5, 10, 15, 20,40,80,120, "All"] // change per page values here
			],
			// set the initial value
			"iDisplayLength" : 40,
		});
